          ...
          <div className="flex items-center gap-12 xl:gap-20 w-full">
            <div className="flex gap-10 items-center">
              ...
              <div className="flex items-center gap-6 ml-4 pl-8 border-l border-[#D4AF37]/20">
                <a href="/login" className="px-5 py-2.5 bg-[#D4AF37]/10 border border-[#D4AF37]/30 rounded text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#03120B] transition-all text-[10px] font-bold tracking-[0.25em] uppercase whitespace-nowrap">Client Login</a>
              </div>
            </div>
